<head>
    ...
    <!-- Icons -->
    <link href="{{asset('assets-profile/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('assets-profile/css/remixicon.css')}}" rel="stylesheet" type="text/css">

    <!-- Iconscout -->
    <link rel="stylesheet" href="{{asset('https://unicons.iconscout.com/release/v4.0.0/css/line.css')}}">
    <link href="{{asset('assets-profile/css/unicons.iconscout.com/release/v3.0.6/css/line.css')}}" rel="stylesheet">
    <!-- Css -->
    <link href="{{asset('assets-profile/css/style-rtl.min.css')}}" rel="stylesheet" type="text/css" id="theme-opt">
